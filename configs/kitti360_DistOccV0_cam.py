...
train_pipeline = [
    ...
    dict(type='CollectData', keys=['img_inputs', 'gt_occ'], meta_keys=['pc_range', 'occ_size', 'raw_img', 'stereo_depth']),
]
...
model = dict(type='CGFormer',
             ...
             VoxFormer_head=dict(
                 ...
                 point_cloud_range=point_cloud_range,
                 embed_dims=_dim_,
                 cross_transformer=dict(type='PerceptionTransformer_DFA3D',
                 ...
                 self_transformer=dict(type='PerceptionTransformer_DFA3D',
                                       rotate_prev_bev=True,
                                       use_shift=True,
                                       embed_dims=_dim_,
                                       num_cams=_num_cams_,
                                       ...
                                       encoder=dict(type='VoxFormerEncoder',
                                                    ...
                                                    num_points_in_pillar=8,
                                                    return_intermediate=False,
                                                    transformerlayers=dict(type='VoxFormerLayer',
                                                                           attn_cfgs=[
                 ...
                 mlp_prior=True),
             occ_encoder_backbone=dict(type='Fuser',
                                       embed_dims=128,
                                       ...
                                       local_aggregator=dict(type='LocalAggregator',
